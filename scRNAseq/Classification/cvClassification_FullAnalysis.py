...
symEnsmbl = pd.read_csv('U5/filtered_gene_bc_matrices/hg19/genes.tsv', header = None, index_col=1, sep='\t')
...
tmp1 = set(list(pd.read_csv('markerGenes/highlyVarGenes_WT_sgTAOK1_1584.csv', header = 0, index_col = 0).loc[:,'x']))
tmp2 = []
missed = []
for j in tmp1:
